...
define("DB_USERNAME", "x_u_11117_risebuilder"); // Mysql baza nomi
define("DB_PASSWORD", "Maker"); // Mysql baza paroli
define("DB_NAME", "x_u_11117_risebuilder"); // Mysql baza nomi
...
[['text'=>"11",'callback_data'=>"avto=Reklamachi"],['text'=>"12",'callback_data'=>"avto=PulBot Lite"],['text'=>"13",'callback_data'=>"avto=VideoDown"],['text'=>"14",'callback_data'=>"avto=TurfaBot"],['text'=>"15",'callback_data'=>"avto=ConvertorBot"]],
]])
]);
}}
...
[['text'=>"11",'callback_data'=>"addb=Reklamachi=$kat"],['text'=>"12",'callback_data'=>"addb=PulBot Lite=$kat"],['text'=>"13",'callback_data'=>"addb=VideoDown=$kat"],['text'=>"14",'callback_data'=>"addb=TurfaBot=$kat"],['text'=>"15",'callback_data'=>"addb=ConvertorBot=$kat"]],
...
Bir marta aylantirish narxi - <b>5000 $pul (Balansdan sarflanadi).</b> Yutib olgan pullaringiz balansingizga tushadi!
<b>💵 Asosiy balans:</b> $get $pul

<b>Ruletkadagi yutuqlar:</b>
0 $pul | 2500 $pul | 5000 $pul | 20000 $pul<b></b>",
'parse_mode'=>'html',
'reply_markup'=>json_encode([
'inline_keyboard'=>[
...
$rand = array('0','0','2500','2500','5000','20000');
$ra = array_rand($rand, 1);
$rand1 = array('0','0','2500','2500','5000','20000');
$ra1 = array_rand($rand1, 1);
$rand2 = array('0','0','2500','2500','5000','20000');
